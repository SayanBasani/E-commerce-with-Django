...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0003_alter_seller_models_seller'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('SELLER', 'Seller'), ('USER', 'user')], default='USER', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.CharField(choices=[('Y', 'YES'), ('N', 'NO'), ('B', 'Block'), ('S', 'Suspended')], max_length=1)),
